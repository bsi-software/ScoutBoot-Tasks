...
import org.eclipse.scout.boot.tasks.commons.model.service.TextService;
...
public class TextDbProviderService implements ITextProviderService {
  ...
  public String getText(Locale locale, String key, String... messageArguments) {
    ...
    if (locale == null && TasksClientSession.get() != null) {
      locale = TasksClientSession.get().getLocale();
    }
