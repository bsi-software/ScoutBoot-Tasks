...
import org.eclipse.scout.boot.tasks.commons.ui.task.AbstractTaskTablePage.Table;
...
public class AbstractTaskTablePage extends AbstractPageWithTable<Table> {
  ...
  protected String getUserId() {
    return TasksClientSession.get().getUserId();
  }
  ...
  private SimpleDateFormat getFormatter() {
    return new SimpleDateFormat("EEEE", TasksClientSession.get().getLocale());
  }
  ...
  public class Table extends AbstractTable {
    ...
    public class AcceptMenu extends AbstractMenu {
      ...
      private boolean acceptTask(UUID taskId) {
        ...
        if (task != null && task.getResponsible().equals(TasksClientSession.get().getUserId())) {
