...
public class TaskController {
  ...
  @RequestMapping("/{id}")
  @PreAuthorize("hasAuthority('org.eclipse.scout.boot.tasks.commons.ui.task.ReadTaskPermission')")
  ...
  @RequestMapping("/all")
  @PreAuthorize("hasAuthority('org.eclipse.scout.boot.tasks.commons.ui.task.ReadTaskPermission') "
      + "and hasAuthority('org.eclipse.scout.boot.tasks.commons.ui.task.ViewAllTasksPermission')")
